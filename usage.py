...
lut = LookupTable(path_data='./data', label='HFD', hfd_path_classes='./data/train/parts_classification', pcl_density=40, crop_size=400, num_points=2048)
lut.make()
...
te.preprocessing(path_test_component='./data/test/models/20102', pcl_density=40, crop_size=400, num_points=2048)

# change to py2 env
te = PoseLookup(path_data='./data')
te.inference(model_path='./data/seg_model/model1.ckpt', test_input='./data/test/welding_zone_test',\
    test_one_component='./data/test/models/20102', batch_size=16)
